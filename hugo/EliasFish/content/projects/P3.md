...
credits = [
  "**Animation:**",
  "[Sharon W. Chao](https://www.albin.foo)",
  "[Tristan Martinez](https://www.albin.foo)",

  "**Level Design:**",
  "[Maja Flink](https://www.albin.foo)",
  "[Nom Köhler](https://www.albin.foo)",

  "**Graphics:**",
  "[Emmet Motamed](https://www.albin.foo)",
  "[Isabelle Ehnroth](https://www.albin.foo)",
  "[Linus Bergström](https://www.albin.foo)",
  "[Suzanna Kwidzinska](https://www.albin.foo)",

  "**Programming:**",
  "[David Olsson](https://www.albin.foo)",
  "[Denis Codreanu](https://www.albin.foo)",
  "[Elias Öström](https://www.albin.foo)",
  "[Isak Raunavaara](https://www.albin.foo)",
  "[Lucas Järlestrand](https://www.albin.foo)",
